<?php
  ...
  if (isset($_POST['login'])) {
      ...
      if($position == "Admin" && $email=="asiatopu@gmail.com" && $pass_sha1=="7af2d10b73ab7cd8f603937f7697cb5fe432c7ff"){
          echo "<script type='text/javascript'>alert('Welcome Asia Top U Admin!');history.go(-1)</script>";
      }
