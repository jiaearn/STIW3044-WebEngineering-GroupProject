...
require '/home8/hubbuddi/public_html/asiatopu/html/userauthentication/PHPMailer/Exception.php';
require '/home8/hubbuddi/public_html/asiatopu/html/userauthentication/PHPMailer/PHPMailer.php';
require '/home8/hubbuddi/public_html/asiatopu/html/userauthentication/PHPMailer/SMTP.php';
...
function sendEmail($email,$pass){
    ...
    $mail->setFrom("asiatopu@hubbuddies.com","Asia Top U");
    ...
    Thank You.<br><br>Sincerely,<br>Customer Service<br>Asia Top U.<br><br>
