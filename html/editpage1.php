...
include("dbconnect.php");
    ...
    if (isset($_POST['updateeditform1'])){
        ...
        $query = "UPDATE `tbl_university` SET year='$year',rank = '$rank', university = '$university', country = '$country', score = '$score' WHERE universityID = '$universityID' ";
        if(mysqli_query($conn, $query))
        {
          echo "<script type='text/javascript'>alert('Success!');window.location.assign('editpage1.php');</script>'";
        }else{
          echo "<script type='text/javascript'>alert('Failed!!');window.location.assign('editpage1.php');</script>'";
        }
    }
...
<head>
    ...
    <link rel="stylesheet" href="../css/editpage1.css">
    <!--Call Table js-->
    ...
    <!------------------------Call Edit Form------------------------>
    <script src="../js/editform1.js"></script>
    <link rel="stylesheet" href="../css/editform1.css">
    <!------------------------Call Edit Form------------------------>
...
<body>
    ...
    <div class="container">
        ...
        <a href="editpage2.php"><div class="rankingsindicator">
	...
	<table id="example" class="display" style="width:100%">
	    ...
	    <tr>
                ...
                <td><button class="btn2" onclick="openEditForm1('<?php echo $year ?>','<?php echo $universityID ?>','<?php echo $rank ?>','<?php echo $university ?>','<?php echo $country ?>','<?php echo $score ?>')"><i class="fa fa-edit" ></i></button></td>
        </tr>
            <?php
	                }
    	        }
