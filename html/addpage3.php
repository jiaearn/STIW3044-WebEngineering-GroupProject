...
<script src="https://kit.fontawesome.com/56e1a6fc52.js" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" href="../css/addpage3.css">
...
<div class="container">
<div class="view">
<p><i class="fas fa-pen"></i><b>&nbsp; View More Info</b></p>
</div><br><br><br>
	
<div class="container2">	
	<div>
<img src="../images/uum.jpg" alt="uum image" class="icon">
	</div>	
	<div style="margin-left:50px;">
	<div style="font-size: 25px">&nbsp; <b>University Utara Malaysia</b></div><br>
	<div style="font-size: 16px">&nbsp; &nbsp; <i class="fas fa-trophy"></i>
		&nbsp Rank&nbsp; &nbsp; &nbsp; &nbsp; :&nbsp; 107</div><br>
	<div style="font-size: 16px">&nbsp; &nbsp;  <i class="fas fa-map-marked-alt"></i>
		&nbsp; Location&nbsp; :&nbsp; Malaysia
		<input type="text" placeholder="Add More" name="location" class="location"></div><br>
	<div style="font-size: 16px">&nbsp &nbsp <i class="fas fa-expand-alt"></i>
		&nbsp; &nbsp; Size&nbsp; &nbsp; &nbsp; &nbsp; :&nbsp; 
		<input type="text" placeholder="Add More" name="size" class="size"></div>
	</div>	
	</div>
	
	<span class="information"><b>&nbsp; &nbsp; More Information</b></span>
	<p class="solid"><input type="text" placeholder="Add More Information...
	" name="info" class="info"><br><button type="submit" class="addbtn">
		<i class="fas fa-plus-circle fa-4x" ></i></button><br><br><br><br></p>
